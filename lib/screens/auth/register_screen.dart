  ...
  Widget _buildBackground(Size size) => AnimatedBuilder(
    ...
    builder: (_, __) {
      ...
      return Stack(children: [
        ...
        Positioned(
          left: size.width * 0.35, top: size.height * 0.4,
          ...
          Expanded(
            child: ListView.separated(
              ...
              separatorBuilder: (_, __) => const Divider(
                  height: 1, color: _N.cardBorder, indent: 20),
              itemBuilder: (ctx, i) {
        ...
        Expanded(
          child: TextFormField(
            ...
            decoration: InputDecoration(
              ...
              errorStyle:
                  const TextStyle(color: _N.rose, fontSize: 11),
            ),
          ),
        ),
        if (suffix != null)
